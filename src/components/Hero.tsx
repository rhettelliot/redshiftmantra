  ...
  return (
    <>
      ...
      >
        <path
          ref={progressRef}
          d="M70 0 C70 20, 30 35, 30 50 S70 80, 70 100"
          fill="none"
      ...
      >
        ...
        <div
          ref={titleRef}
          className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 items-center"
        >
          {/* Left: text block */}
